...
<div class="header_container container-fluid">
    <div class="row header">
        <div class="col-lg-3 col-lg-offset-1 col-md-2  text-center header_part" style=" padding: 8px">
            <img src='<c:url value="/images/logo.png"/>' class="img-rounded" style="height: 85%; margin-top: 10px;">
        </div>

        <div class="col-lg-5 col-lg-offset-0 col-md-6 col-md-offset-1 text-center header_part">
        ...
        <div class="col-lg-3 col-md-2  header_part">
            <div class="nav navbar-nav header_menu_item">
